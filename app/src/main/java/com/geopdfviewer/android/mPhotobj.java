...
public class mPhotobj {
    ...
    public mPhotobj(String m_POIC, String m_name, String m_time, String m_path) {
        this.m_POIC = m_POIC;
        this.m_name = m_name;
        this.m_time = m_time;
        this.m_path = m_path;
    ...
    public mPhotobj(String m_POIC, String m_name, String m_time, String m_path, float m_X, float m_Y) {
        this.m_POIC = m_POIC;
        this.m_name = m_name;
        this.m_time = m_time;
        this.m_path = m_path;
